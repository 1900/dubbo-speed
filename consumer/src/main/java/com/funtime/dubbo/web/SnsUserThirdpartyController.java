...
import com.funtime.dubbo.config.ResourcesConfig;
import com.funtime.dubbo.config.ThirdPartyLoginHelper;
...
public class SnsUserThirdpartyController {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Reference(version = "1.0.0")
    private ISnsUserThirdpartyService userThirdpartyService;
    ...
    private  Map<String, Object>  thirdPartyLogin(HttpServletRequest request, ThirdPartyUser param) throws Exception{
        User sysUser;
        // 查询是否已经绑定过
        SnsUserThirdparty userThirdparty = userThirdpartyService.selectOne(new EntityWrapper<SnsUserThirdparty>()
        ...
        return userService.getLoginUserInfo(sysUser);
    }

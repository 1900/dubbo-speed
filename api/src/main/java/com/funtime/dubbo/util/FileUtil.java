...
public class FileUtil {
    ...
    public static File[] getFiles(String str) {
        File dir = new File(StringUtils.utf8Decoding(str));
        File[] result = null;
        if (dir.isDirectory()) {
    ...
    public static String readFileContent(File file, String fullFilePath) throws IOException {
        String returnStr = "";
        if (StringUtils.isEmpty(file) && StringUtils.isEmpty(fullFilePath)) {
            return "";
        }
    ...
    public static boolean writeToFile(String content, File file, String fullFilePath) throws IOException {
        if ((StringUtils.isEmpty(file) && StringUtils.isEmpty(fullFilePath)) || StringUtils.isEmpty(content)) {
            return false;
        }
        if (StringUtils.isEmpty(file)) {
            file = new File(fullFilePath);
